...
| [ATC202](docs/rules/ATC202.md) | Style | Multi parameters should be separated onto individual lines | ⚠️ Warning | ✔️ Yes | ✅ Yes |
| [ATC203](docs/rules/ATC203.md) | Style | Method chains with 2 or more calls should be broken onto separate lines | ⚠️ Warning | ✔️ Yes | ✅ Yes |
