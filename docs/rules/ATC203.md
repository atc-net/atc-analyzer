...
7. **Interpolated strings**: Method chains inside interpolated strings are excluded from this rule - see [ATC204](ATC204.md) for interpolation-specific analysis
...
4. **Interpolated strings**: Method chains inside interpolated strings are excluded from this rule. See [ATC204](ATC204.md) for interpolation-specific analysis that suggests extracting complex expressions to variables.
...
- [ATC204: Chained method calls in interpolated strings should be simplified](ATC204.md) - Interpolation-specific method chain analysis
